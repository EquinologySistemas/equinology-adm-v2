...
export default function ReportsPage() {
  return (
    <div className="space-y-8">
      ...
      <section className="overflow-hidden rounded-xl border border-[var(--dash-border)] bg-white shadow-sm">
      ...
      <p className="flex items-center gap-2 text-xs text-[var(--dash-text-muted)]">
        ...
        Gráficos e exportação em PDF serão habilitados quando a API de
        relatórios estiver disponível.
      </p>
    </div>
  );
}
